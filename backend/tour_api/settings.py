...
SECRET_KEY = 'django-insecure-%fh6mjn(*237e1d8txvo)3$ia$b#hh1_+lr80kvv=52r2=tiay'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["127.0.0.1", "localhost"]  # ✅ Allow local frontend access
...
#     "http://localhost:3000",  # ✅ If using React, Vue, or Angular
# ]

# CSRF Protection for API Testing
